...
if not SECRET_KEY:
    raise ValueError("SECRET_KEY must be set in Environment variables or .env.local!")
...
# Use Cloudinary for Media Storage only if settings are provided
...
UNFOLD = {
    "SITE_TITLE": "Japan Journey Explorer Admin",
